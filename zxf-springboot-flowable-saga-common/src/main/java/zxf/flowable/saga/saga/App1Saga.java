...
public class App1Saga {
    ...
    public String getPrefix() {
        return "app1@" + flowableService.appName();
    }
    ...
    private BpmnModel buildSaga() {
        ...
        SagaBuilder sagaBuilder = SagaBuilder.newSaga(this.sagaName, flowableService.asyncBefore(), flowableService.asyncAfter())
                .activityNoRetry("App1-Task 1", "zxf.flowable.saga.task.app1.App1Task1Adapter")
                .compensationActivity("App1-Undo Task 1", "zxf.flowable.saga.task.app1.App1Task1UndoAdapter")
                .activityNoRetry("App1-Task 2", "zxf.flowable.saga.task.app1.App1Task2Adapter")
                .compensationActivity("App1-Undo Task 2", "zxf.flowable.saga.task.app1.App1Task2UndoAdapter")
                .activityNoRetry("App1-Task 3", "zxf.flowable.saga.task.app1.App1Task3Adapter")
                .end()
